...
<%--
        ...
        <div class="w3-container">
            ...
            <c:forEach var="books" items="${books}" >
                <c:url var="dodajDoKoszyka" value="/koszyk/dodaj">
                    <c:param name="id" value="${books.id}"/>
                </c:url>
                <li class="w3-bar">
                    <a href="${dodajDoKoszyka}" class="w3-bar-item w3-button w3-white  w3-right">Dodaj do koszyka </a>
                    <img src="<c:url value="/resources/images/ksiazka.jpg"/>" class="w3-bar-item w3-hide-small" style="width:100px">
                    <div class="w3-bar-item">
                        <span class="w3-large">${books.nazwa}</span><br>
                        <c:forEach var="autor" items="${books.autorzy}" >
                            <span >${autor.imie} ${autor.nazwisko} </span>&nbsp;&nbsp;
                        </c:forEach>
                        <br>
                        <div class="w3-small w3-left">${books.kategoria.nazwa}</div>
                    </div>
                    <div class="w3-bar-item w3-right">
                        <span class="w3-large">Cena: ${books.cena}</span><br>
