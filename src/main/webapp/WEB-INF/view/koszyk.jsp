...
<div class="w3-main" style="margin-left:250px">
    ...
    <div id="main">
        <div class="w3-container">
            <h2>Koszyk</h2>
            <c:if test="${msg != null}">
                <div class="w3-container w3-xlarge w3-padding" style="height: 300px">${msg}</div>
            </c:if>
            ...
            <c:if test="${razem > 0}">
                <table class="w3-table w3-bordered">
                    ...
                    <c:forEach var="ksiazka" items="${koszyk.ksiazki}" >
                        <c:url var="usun" value="/koszyk/usun">
                            <c:param name="id" value="${ksiazka.id}"/>
                        </c:url>
                        <tr>
                            <td>${ksiazka.nazwa}</td>
                            <td>${ksiazka.cena}</td>
                            <td><a href="${usun}" class="w3-button w3-right w3-white w3-tiny w3-margin-right" >Usuń</a></td>
                        </tr>
                    </c:forEach>
                </table>

                <div class="w3-right w3-container w3-padding" style="height: 120px; margin-right: 100px">
                    <h3>RAZEM: ${razem}</h3>
                </div>
                <div class="w3-container w3-padding" style="width: 70%; margin: auto; height: 200px">
                    <a href="${pageContext.request.contextPath}/books/list" class="w3-button w3-left w3-black" style="width: 45%">Kontynuuj zakupy</a>
                    <a href="${pageContext.request.contextPath}/koszyk/zloz-zamowienie" class="w3-button w3-right w3-black" style="width: 45%">Złóż zamówienie</a>
                </div>
            </c:if>
        </div>
