...
<div class="w3-main" style="margin-left:250px">
    ...
    <div id="main">
        <%--            <table>
                        ...
                        <c:forEach var="autorzy" items="${autorzy}" >
                            ...
                            <c:url var="getBooks" value="/books/list">
                                <c:param name="autor" value="${autorzy.id}"/>
                            </c:url>
                            <tr>
                                <td>${autorzy.imie}</td>
        ...
        <div class="w3-container">
            ...
            <c:if test="${msg != null}">
                <div class="w3-container w3-xlarge w3-padding" style="height: 100px">${msg}</div>
            </c:if>
            <c:if test="${msg == null}">
                <ol class="w3-ul">
                    <li class=" w3-bar">
                        <div class="w3-bar-item">
                            ...
                            <span class="w3-block w3-left w3-center" style="width:400px"><b>Kwota</b> </span>
                        </div>
                    </li>
                    <c:forEach var="zamowienie" items="${zamowienia}" >
                        <li class ="w3-bar">
                            <div class="w3-bar-item">
                                ...
                                <span class="w3-block w3-left w3-center" style="width:400px">${zamowienie.kwota} zł</span>
