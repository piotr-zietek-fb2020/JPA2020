...
<div class="w3-main" style="margin-left:250px">
    ...
    <div id="main">
        <div class="w3-display-container">
            <img src="<c:url value="/resources/images/tlo.png"/>"style="width:100%;">
        </div>
        <div class="w3-container">
        <h1>Witaj w naszej księgarni</h1>
            <sec:authorize access="!isAuthenticated()">
            <p>Aby składać nowe zamówienia musisz się zalogować.</p>
            <p>Jeśli nie masz jeszcze konta, wybierz Moje konto -> rejestracja.</p>
            </sec:authorize>
            <sec:authorize access="isAuthenticated()">
            <p>Jesteś zalogowany. Teraz możesz składać nowe zamówienia.</p>
            <p>Udanych zakupów.</p>
            </sec:authorize>
        </div>
