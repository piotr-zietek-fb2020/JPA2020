                ...
                <div class="w3-container">
                    <div class="w3-half">
                        <table>
                            ...
                            <tr>
                                ...
                                <td><form:input class="w3-input" path="wydawnictwo" /></td>
                            </tr>
                            <tr>
                                <td><label>cena:</label></td>
                                <td><form:input class="w3-input" path="cena" /></td>
                            </tr>
                            <tr>
                                <td><label>kategoria:</label></td>
                                <td><form:select class="w3-select" path="kategoria.id" items="${kategorie}" itemLabel="nazwa" itemValue="id" /></td>
                            </tr>
                            </tbody>
                        </table>
                    </div>
                    <div class="w3-half">
                        <c:forEach var="autor" items="${autorzy}">
                            <form:checkbox path="listaAutorow" value="${autor.id}"/>    ${autor.imie} ${autor.nazwisko} <br>
                        </c:forEach>
                    </div>
                </div>
